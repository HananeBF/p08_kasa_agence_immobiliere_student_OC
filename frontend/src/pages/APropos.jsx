        ...
        <>
          <Collapse title="Fiabilité">
            <p>
              ...
              Les photos sont conformes aux logements, et toutes lesinformations
        ...
        <>
          <Collapse title="Sécurité">
            <p>
              ...
              à l'hôte qu'au locataire, cela permet de vérifier que les
              standards sont bien respectés. Nous organisons également des
              ateliers sur la sécurité domestique poour nos hôtes.
            </p>
          </Collapse>
        </>
      </div>
